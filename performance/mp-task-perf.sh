...
for ((i = 1; i <= iterations; i++)); do
    result=$(perf stat --log-fd 1 ../open_mp_tasks_impl/cmake-build-debug/open_mp_tasks_impl ../examples/9x9/sudoku_5.csv ../examples/9x9/solution_5.csv | awk '/time elapsed/ {print $1}')
